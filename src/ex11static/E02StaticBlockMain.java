...
/*
 static 블럭
 : 동일 클래스 내 main() 메서드보다 먼저 실행되는 블럭으로 main 메서드의
...
public class E02StaticBlockMain {
	...
	// static 블럭 정의
	static {
		// 블럭내에서 정적멤버 변수에 접근할 수 있다.
		staticVar = 1000;		

		/* 블럭 내에서만 사용할 수 있는 변수로, 블럭 내에서는 일반 변수를 
		 생성한 후 사용할 수 있다. */
		int localVar;
		localVar = 1000;
...
//		instanceMethod();
	...
	/*
	 생성자 메서드 : 생성자에서는 정적멤버에 접근할 수 있다. 일반적인
	 	멤버변수와 동일하다.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 static 블럭내에서 선언된 변수는 지역변수이므로 main 메서드에서는
