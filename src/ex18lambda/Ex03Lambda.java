...
/*
 ...
 이러한 불편함 때문에 함수형 프로그래밍(Functional Programming)의 장정이
 대두도었고, 이런 Java의 단점을 보안하기 위해 JDK1.8부터 람다식을 지원하게되었다.
 */
...
public class Ex03Lambda {
	...
	public static void main(String[] args) {
		/*
		 2번 예제의 익명클래스를 다음과 같은 람다식으로 표현 할 수 있다.
		 	1. 함수명을 제거한다. 어차피 부모 인터페이스로부터 오버라이딩 했으므로
		 	동일한 이름인 것을 우리는 알고있다.
		 	2. 람다식 임을 표현하기 위한 소괄호와 중괄호 사이에 화살표를 삽입한다.
		...
		/*
		 ...
		 ISchool3 인터페이스의 추상 메서드를 통해 매개변수의 타입을 유추할 수
