...
//		numOfFriends = 0;
	...
	public void addFriend(int choice) {
		...
		/*
		 List<E>는 자동인덱싱이 지원되므로 인스턴스 추가를 위해 index 변수를
...
//						new FileOutputStream("src/ex20io/FriendList.obj"));
...
//						new FileInputStream("src/ex20io/FriendList.obj"));
...
//	}
	...
	public void readFriendInfo() {
		try {			
			...
			/*
			 파일에 친구의 정보가 몇개 저장되어는지 확인할 수 없으므로
			 무한루프로 구성한다.
			 */
			while(true) {
				/*
				 직렬화될 때 Object 기발으로 저장되므로 반드시
				 다운캐스팅 해야한다.
				 */
			...
			/*
			 예외가 발생하면 catch절로 예외 인스턴스가 던져지므로 while루프를
			 탈출할 수 있다.
			 */
...
public class E12MyFriendSerializable {
	...
	public static void main(String[] args) {
		...
		/*
		 프로그램을 시작하면 obj파일에 있는 내용을 복원(역직렬화)해서 
		 List에 추가한다.
		 */
