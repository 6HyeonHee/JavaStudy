...
/*
 추상화(Abstraction) : 현실세계의 사물을 클래스로 형상화하는 것을 말한다.
 	Person클래스는 "사람"의 일반적인 속성을 클래스로 추상화한 것이다.
 	
 클래스 선언 시 class 예약어를 사용한다. 클래스명 첫글자는 반드시 대문자를 사용해야한다.
 또한 public 접근 지정자는 하나의 Java파일에 한번만 사용할 수 있다.
 => public 클래스명은 팡리명과 동일해야하기 때문이다.
 */
class Person {
	/*
	...
	/*
	 멤버메서드 : 클래스에서 객체의 동작(행위)를 표현한다. 클래스 외부에서
	 	호출할 때는 참조변수를 통해 .(닷)으로 접근한다. 또한 멤버변수는
...
public class E01PersonMain {
	...
	public static void main(String[] args) {
		...
		/*
		 Person 클래스를 통해 인스턴스를 생성한다. 생성 시 할당된 주소값을
