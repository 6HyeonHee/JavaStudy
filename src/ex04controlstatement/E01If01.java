...
// 아래에 있는 read 함수때문에 사용 -> 추후에 학습 예정
...
//		}
		...
		// 2가지 조건 모두 만족(true)하므로 print()문이 실행된다.
		if(num%2==0 && num>=10) {
			System.out.printf("%d는 짝수이고 10보다 크거나 같다.", num);
		}
		...
		*/
		...
		/*
		 아스키코드를 알고있을 때의 구현방법. 문자 0과 9가 각각 아스키코드 48, 57에
		 해당하므로 구간내에 있는지 확인할 수 있다.
		 */
