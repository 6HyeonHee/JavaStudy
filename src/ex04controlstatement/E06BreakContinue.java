...
/*
 break : 반복문이나 switch문에서 주로 사용되며 블럭내에서 탈출할 때 사용한다.
...
public class E06BreakContinue {
	...
	public static void main(String[] args) {
		...
		int i = 0;
		// 무한 루프 조건으로 while문 작성
		while(true) {
			/*
			 반복문 내에서 break, continue를 사용할 때는 반드시 조건문과 같이 사용해야한다.
		...
		/*
		 중첩된 반복문 안에서 break를 만나면 "가장 가까운 반복문 하나"만 탈출한다.
		 반복문 전체를 탈출하는 것이 아니므로 주의해야한다.
		 */
		for(int x=1; x<=5; x++) {
			// x는 5까지 전체 출력된다
