...
class MyChild extends MyParent {
	...
	/*
	 메스드명은 동일하지만 매개변수가 틀리므로 오버로딩한 메서드임.
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		// 오버라이딩 해서 재정의한 메서드(자식쪽의 메서드가 호출됨)
		...
		// 부모타입으로 자식이스턴스에 접근할 수 없으므로 에러발생
//		parent1.childMember = 1;
		// 오버라이딩 한 메서드이므로 자식쪽이 호출된다. (부모를 타고 자식으로 슝~)
		parent1.parentMethod();
		
		System.out.println("");
		System.out.println("[부모 참조변수로 자식 인스턴스를 참조한 두번째 변수 생성]");
