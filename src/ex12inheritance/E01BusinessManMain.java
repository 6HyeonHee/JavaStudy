...
class BusinessMan extends Man {
	...
	/*
	 상속받은 자식 클래스의 생성자를 호출하여 부모 인스턴스가
	 메모리에 먼저 생성되도록 해야한다. super()는 부모클래스의
	 생성자를 호출한다. 만약 super()를 기술하지 않으면 컴파일러에
	 의해 자동으로 삽입되어 디폴트 생성자가 호출됩니다.
	 */
	...
	public void tellYourInfo() {
		...
		/*
		 ...
		 자식클래스에서는 접근할 수 없다. private멤버는 무조건 클래스 내부에서만
		 접근할 수 있다.
		 */
//		System.out.println("이름은 "+ name +" 입니다.");
		/*
		 부모클래스에 public으로 선언된 메서드를 통해 간접적으로
		 접근하여 사용할 수 있다.
		 */
		tellYourName();
	}
