...
/*
 배열 : 순차적인 메모리의 공간이 할당되는 형태로써 하나가 아니라 여러개의
 	  변수가 필요한 경우에 사용한다.
 - Java에서는 배열의 인스턴스 형태로 생성하므로 new를 사용한다.
...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		 인스턴스배열 : 기본자료형을 저장하는 배열이 아닌 인스턴스의 참조값을 저장할
		 			목적으로 생성한 배열을 말한다. 사용법은 일반배열과 동일하다.
		 */
		...
		/*
		 배열을 선언과 동시에 초기화하는 경우 자바 컴파일런는 초기값의 갯수를 통해
		 배열의 크기를 결정할 수 있다. 따라서 이 경우네느 크기는 생략하도록 약속되어있다.
		 */
