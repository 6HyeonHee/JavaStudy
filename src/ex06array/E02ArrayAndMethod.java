...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		/*
		 ...
		 생성된 배열 인스턴스의 주고값을 int형 배열변수인 arr에 할당하게된다.
		 */
		int[] arr = {1, 2, 3, 4, 5};
		...
		System.out.println();
		/*
		 배열명을 출력하면 메모리의 주소값이 문자열형태로 출력된다.
		 즉 배열명은 배열에 저장된 값 자체가 아닌 Heap 영역에 생성된
		 메모리의 주소값을 저장하게 된다.
		 */
		...
		/*
		 ...
		 메서드에서 반환한 참조값을 ref로 할당되므로 결국 같은 배열을 참조하게 된다.
		 */
		ref = addAllArray(arr, 7);
		
		/*
		 main에서 생성했던 배열 객체의 참조값을 매개변수로 넘기고,
