...
public class E05ConstantVar {
	...
	public static void main(String[] args) {
		...
		/*
		 상수 : 저장된 값이 변하지 않는 메모리의 한 종류로 선언할 때, 앞부분에 final을 붙여준다.
		 - 상수는 최대 한번만 초기화되고, 이후에는 값을 변경할 수 없다.
		 - 선언 시 전체를 대문자로 기술한다. 만약 연결할 단어가 있다면 가독성을 위해 
		   '언더바(언더스코어)'를 사용한다.
...
//		PI = 3.141592;
		...
		// 단, 초기화가 안된 상태에서 사용할 수 없어 에러가 발생한다.
