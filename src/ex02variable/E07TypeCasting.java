...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 자동형변환 : 작은 자료형의 데이터를 큰 자료형에 대입할 대 자동으로 형변환이 일어난다.
		 */
		byte b1 = 65;
		short s1;
		...
		/*
		 아래코드는 자동형변환이 아니다. CPU는 int보다 작은 자료형을 연산할 떄는
...
//		char ch1 = b1;
		...
		/*
		 소수점 아래부분이 버려지므로 데이터 손실이 있는 경우이다. (그냥 버림임. 3.64 -> 3)
		...
		/*
		 문자는 메모리에 저장 시 아스키코드로 저장되므로 int와의 연산을 진행한 후
