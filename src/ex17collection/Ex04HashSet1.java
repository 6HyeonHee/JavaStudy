...
public class Ex04HashSet1 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 저장할 수 있다. (아래 3가지 모두 사용 가능하지만 1,3번을 자주 사용함.)
		 */
...
//		HashSet<Object> set = new HashSet<>();
		 ...
		 */
		// 1. set 참조변수를 통해 Iterator 인스턴스를 생성한다.
		Iterator itr = set.iterator();
		// 2. 인출할 인스턴스가 있는지 확인하다.
		while(itr.hasNext()){  
			...
			/*
			 ...
			 getName()을 호출할 수 없다.
			 */
			// (순서없이 출력되므로 컴퓨터마다 출력 순서가 다를 수 있음!!)
		 ...
		 */
		set.clear();
		// 위에서 전체 삭제 되었으므로 false가 결과로 나온다.
