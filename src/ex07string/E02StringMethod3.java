...
public class E02StringMethod3 {
	public static void main(String[] args) {
		...
		/*
		 11] lastIndexOf() : 사용법은 indexOf()와 동일하지만 문자열의 뒤에서부터 찾는 것이 특징이다.
		 					파일의 확장자를 찾아야하는 업무에서는 뒤에서부터 찾아야 하는 경우가 발생하게 된다.
		 */
		...
		/*
		 split() : 문자열을 구분자를 통해 분리해서 String형의 배열로 반환한다.
