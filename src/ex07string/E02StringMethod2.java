...
public class E02StringMethod2 {
	public static void main(String[] args) {
		...
		/*
		 6] codePointAt(index) : 문자열의 특정 인덱스의 문자를 찾은 후
		 						아스키코드(혹은 유니코드)를 반환한다.
		 */
		System.out.println("### 6 ###");
		// 대문자 W : 87
		System.out.println("str1 첫번째 문자의 아스키 코드: "+ str1.codePointAt(0));
		// 한글 '야' : 50556
		System.out.println("str2 세번째 문자의 아스키 코드: "+ str2.codePointAt(2));
		...
		/*
		 9] format() : 출력형식을 지정하여 문자열로 반환할 때 사용한다. 
		 			  printf()와 사용법은 동일하고, 주로 웹애플리케이션 제작에 사용된다.
		 */
