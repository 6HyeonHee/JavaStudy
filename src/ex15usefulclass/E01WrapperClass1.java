...
/*
 Wrapper class : 깁노자료형의 데이터를 인스턴스화할 때 사용하는 클래스로
 	Boxing 혹은 Unboxing을 통해 기본자료형의 데이터를 인스턴스화한다.
...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		 JDK1.4 이전의 코딩형식
		 기본자료형을 박싱 처리한 인스턴스에 대해 산술연산을 진행할 떄
		 언박싱을 위해 intValue()와 같은 메서드를 호출해야한다.
		 */
