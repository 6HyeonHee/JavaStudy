...
/*
 Java의 규칙 : java.lang패키지 하위의 모든 클래스는 자동으로 import 된다.
...
public class E03MathClass extends Object {
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 메서는 static으로 선언되어 있어 인스턴스 생성없이 클래스명으로
		   호출할 수 있다.
		 */
		System.out.println("원주율 : " + Math.PI);
		
		// 정수와 실수형 변수 선언
		float f = -3.14f; // 실수는 double로 생각하기에 f를 붙여야 float형이 된다.
		double d = -100.9;
		int num = -10;
